...
const additions: Artifact[] = [
  ...
  demoArtifact('artifact-08', 'VeryCD', 'VERYCD', '资源索引 / P2P 社区', 2004, 2011, '影音下载服务调整', '#5a855d'),
  ...
  demoArtifact('artifact-13', '飞信', 'FETION', '即时通讯 / 短信互通', 2007, 2022, '服务停止', '#3f8d45'),
...
const all = [...baseArtifacts, ...additions]

const exhibitMeta: Record<string, CatalogArtifact['exhibit']> = {
  'artifact-01': { collectionNo: 'A-004', englishName: 'TIANYA', eventYear: 2023, eventLabel: '暂停访问', accent: '#bc4a3c', mainExhibit: true, side: 'left', lane: .86 },
  ...
  'artifact-03': { collectionNo: 'A-009', englishName: 'BAIDU SPACE', eventYear: 2015, eventLabel: '公开空间迁移', accent: '#6b9a63', mainExhibit: true, side: 'right', lane: .74 },
  ...
  'artifact-08': { collectionNo: 'A-007', englishName: 'VERYCD', eventYear: 2011, eventLabel: '影音下载服务调整', accent: '#5a855d', mainExhibit: true, side: 'left', lane: .72 },
  'artifact-09': { collectionNo: 'A-006', englishName: 'TTPLAYER', eventYear: 2013, eventLabel: '品牌整合更名', accent: '#d3aa48', mainExhibit: true, side: 'right', lane: .66 },
  'artifact-10': { collectionNo: 'A-005', englishName: 'SHOOTER', eventYear: 2014, eventLabel: '网站关闭', accent: '#8a6e42', mainExhibit: true, side: 'left', lane: .82 },
  'artifact-11': { collectionNo: 'A-010', englishName: 'NETEASE BLOG', eventYear: 2018, eventLabel: '停止运营', accent: '#88a34f', mainExhibit: true, side: 'right', lane: .7 },
  ...
  'artifact-13': { collectionNo: 'A-012', englishName: 'FETION', eventYear: 2022, eventLabel: '服务停止', accent: '#3f8d45', mainExhibit: true, side: 'right', lane: .72 },
...
export const catalogArtifacts = all.map((artifact) => ({
  ...artifact,
